...
import { AnyMySqlSelectQueryBuilder, GetMySqlSetOperators, LockConfig, LockStrength, MySqlCreateSetOperatorFn, MySqlCrossJoinFn, MySqlJoinFn, MySqlSelectConfig, MySqlSelectDynamic, MySqlSelectHKTBase, MySqlSelectKind, MySqlSelectQueryBuilderHKT, MySqlSelectWithout, MySqlSetOperatorExcludedMethods, MySqlSetOperatorWithResult, SelectedFields, SetOperatorRightSelect } from "./select.types.cjs";
...
interface MySqlSelectBuilderConstructor {
  new (config: {
...
declare class MySqlSelectBuilder<TSelection extends SelectedFields | undefined, THKT extends MySqlSelectHKTBase = MySqlSelectQueryBuilderHKT> {
  private builder;
  ...
  constructor(config: {
    ...
    withList?: Subquery[];
    distinct?: boolean;
  }, builder?: MySqlSelectBuilderConstructor);
  from<TFrom extends MySqlTable | Subquery | MySqlViewBase | SQL>(source: TFrom, onIndex?: TFrom extends MySqlTable ? IndexConfig : 'Index hint configuration is allowed only for MySqlTable and not for subqueries or views'): MySqlSelectKind<THKT, GetSelectTableName<TFrom>, TSelection extends undefined ? GetSelectTableSelection<TFrom> : TSelection, TSelection extends undefined ? 'single' : 'partial', GetSelectTableName<TFrom> extends string ? Record<GetSelectTableName<TFrom>, 'not-null'> : {}, false, never>;
}
...
//#endregion
export { IndexConfig, IndexForHint, MySqlSelect, MySqlSelectBase, MySqlSelectBuilder, MySqlSelectBuilderConstructor, except, exceptAll, intersect, intersectAll, union, unionAll };
