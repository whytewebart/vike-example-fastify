...
import { getTableColumns, getTableLikeName, haveSameKeys, orderSelectedFields } from "../../utils.js";
...
var MySqlSelectBuilder = class {
	...
	withList = [];
	distinct;
	constructor(config, builder = MySqlSelectBase) {
...
var MySqlSelectBase = class extends TypedQueryBuilder {
...
//#endregion
export { MySqlSelectBase, MySqlSelectBuilder, except, exceptAll, intersect, intersectAll, union, unionAll };
