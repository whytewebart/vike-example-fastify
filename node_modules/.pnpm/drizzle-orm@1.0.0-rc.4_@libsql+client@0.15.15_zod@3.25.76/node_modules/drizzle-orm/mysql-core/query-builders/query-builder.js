...
var QueryBuilder = class {
	...
	$with = (alias, selection) => {
		...
		const as = (qb) => {
			...
			return new Proxy(new WithSubquery(("withoutSelectionCastCodecs" in qb ? qb.withoutSelectionCastCodecs() : qb).getSQL(), selection ?? ("getSelectedFields" in qb ? qb.getSelectedFields() ?? {} : {}), alias, true), new SelectionProxyHandler({
				alias,
