...
var MySqlSelectBase = class extends __query_builders_query_builder_ts.TypedQueryBuilder {
	...
	*/
	...
	getSQL() {
		this.config.fieldsFlat = (0, __utils_ts.orderSelectedFields)(this.config.fields, void 0, this.dialect.codecs);
