...
var QueryBuilder = class {
	...
	$with = (alias, selection) => {
		...
		const as = (qb) => {
			...
			return new Proxy(new __subquery_ts.WithSubquery(("withoutSelectionCastCodecs" in qb ? qb.withoutSelectionCastCodecs() : qb).getSQL(), selection ?? ("getSelectedFields" in qb ? qb.getSelectedFields() ?? {} : {}), alias, true), new __selection_proxy_ts.SelectionProxyHandler({
				alias,
