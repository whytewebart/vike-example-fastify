...
var RelationalQueryBuilder = class {
	...
	constructor(schema, table, tableConfig, dialect, session, builder = MySqlRelationalQuery) {
		this.schema = schema;
		this.table = table;
	...
	findMany(config) {
		return new this.builder(this.schema, this.table, this.tableConfig, this.dialect, this.session, config ?? true, "many");
	}
	findFirst(config) {
		return new this.builder(this.schema, this.table, this.tableConfig, this.dialect, this.session, config ?? true, "first");
	}
};
var MySqlRelationalQuery = class {
