...
import { MySqlEffectUpdateBase } from "./update.js";
import { MySqlEffectCountBuilder } from "./count.js";
import { MySqlEffectDeleteBase } from "./delete.js";
import { MySqlEffectInsertBase } from "./insert.js";
import { MySqlEffectRelationalQuery } from "./query.js";
import { MySqlEffectRaw } from "./raw.js";
import { MySqlEffectSelectBase } from "./select.js";
...
var MySqlEffectDatabase = class {
	static [entityKind] = "MySqlEffectDatabase";
	query;
	constructor(dialect, session, relations) {
		...
		this.query = {};
		for (const [tableName, relation] of Object.entries(relations)) this.query[tableName] = new RelationalQueryBuilder(relations, relations[relation.name].table, relation, dialect, session, MySqlEffectRelationalQuery);
	...
	*/
	update(table) {
		return new MySqlUpdateBuilder(table, this.session, this.dialect, void 0, MySqlEffectUpdateBase);
	}
	/**
	...
	*/
	...
	execute(query) {
		...
		return new MySqlEffectRaw(this.session.prepareQuery(builtQuery, "raw"), sequel, builtQuery);
	}
...
//#endregion
export { MySqlEffectDatabase, withReplicas };
