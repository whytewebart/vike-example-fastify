...
import { MySqlColumnType } from "../codecs.cjs";
...
interface CustomTypeParams<T extends CustomTypeValues> {
   ...
   */
  codec?: MySqlColumnType | undefined | ((config: T['config'] | (Equal<T['configRequired'], true> extends true ? never : undefined)) => MySqlColumnType | undefined);
}
/**
