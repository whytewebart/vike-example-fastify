...
const require_planetscale_serverless_codecs = require('./codecs.cjs');
...
var PlanetScaleDatabase = class extends __mysql_core_async_db_ts.MySqlAsyncDatabase {
...
const db = drizzle({ client });
	...
	const dialect = new __mysql_core_dialect_ts.MySqlDialect({
		...
		codecs: config.codecs ?? require_planetscale_serverless_codecs.planetscaleServerlessCodecs
	});
	let logger;
