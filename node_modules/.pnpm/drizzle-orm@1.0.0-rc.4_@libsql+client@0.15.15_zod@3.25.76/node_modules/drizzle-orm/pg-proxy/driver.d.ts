...
import { PgDialect, PgDialectConfig } from "../pg-core/dialect.js";
...
declare function drizzle<TRelations extends AnyRelations = EmptyRelations>(callback: RemoteCallback, config?: DrizzlePgConfig<TRelations>, _dialect?: (config?: PgDialectConfig) => PgDialect): PgRemoteDatabase<TRelations>;
//#endregion
