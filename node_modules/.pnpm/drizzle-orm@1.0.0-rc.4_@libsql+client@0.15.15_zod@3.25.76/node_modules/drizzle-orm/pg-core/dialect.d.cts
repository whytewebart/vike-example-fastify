...
import { PgSelectConfig, SelectedFieldsOrdered } from "./query-builders/select.types.cjs";
...
declare class PgDialect {
  ...
  buildSetOperations(leftSelect: SQL, leftSelection: SelectedFieldsOrdered, ignoreSelectionCastCodecs: boolean | undefined, setOperators: PgSelectConfig['setOperators']): SQL;
