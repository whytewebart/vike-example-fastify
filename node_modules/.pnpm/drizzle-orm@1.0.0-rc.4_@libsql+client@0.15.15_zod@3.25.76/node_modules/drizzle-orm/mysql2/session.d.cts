...
import { AnyMySqlMapper, MySqlPreparedQueryConfig, MySqlQueryResultHKT, MySqlTransactionConfig } from "../mysql-core/session.cjs";
...
declare class MySql2Session<TRelations extends AnyRelations> extends MySqlAsyncSession<MySqlQueryResultHKT, TRelations> {
  private client;
  private relations;
  private options;
...
declare class MySql2Transaction<TRelations extends AnyRelations> extends MySqlAsyncTransaction<MySql2QueryResultHKT, TRelations> {
  static readonly [entityKind]: string;
