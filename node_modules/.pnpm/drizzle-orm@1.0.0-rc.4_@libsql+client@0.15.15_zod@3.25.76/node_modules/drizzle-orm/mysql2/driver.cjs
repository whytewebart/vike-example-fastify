...
const require_mysql2_codecs = require('./codecs.cjs');
const require_mysql2_session = require('./session.cjs');
let __entity_ts = require("../entity.cjs");
let __utils_ts = require("../utils.cjs");
let __logger_ts = require("../logger.cjs");
let __mysql_core_async_db_ts = require("../mysql-core/async/db.cjs");
...
var MySql2Database = class extends __mysql_core_async_db_ts.MySqlAsyncDatabase {
...
function construct(client, config = {}) {
	...
	const dialect = new __mysql_core_dialect_ts.MySqlDialect({
		...
		codecs: require_mysql2_codecs.mysql2Codecs
	});
	let logger;
...
function drizzle(...params) {
	...
	return construct(typeof connection === "string" ? (0, mysql2_promise.createPool)({ uri: connection }) : (0, mysql2_promise.createPool)(connection), DrizzleMySqlConfig);
}
(function(_drizzle) {
	function mock(config) {
		return construct({ config: {} }, config);
	}
	_drizzle.mock = mock;
})(drizzle || (drizzle = {}));
...
Object.defineProperty(exports, 'MySqlDatabase', {
  enumerable: true,
  get: function () {
    return __mysql_core_async_db_ts.MySqlAsyncDatabase;
  }
});
