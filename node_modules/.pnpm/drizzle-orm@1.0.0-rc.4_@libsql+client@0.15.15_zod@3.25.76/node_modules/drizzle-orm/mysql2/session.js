...
var MySql2Session = class MySql2Session extends MySqlAsyncSession {
	...
	prepareQuery(query, mode, mapper, queryMetadata, cacheConfig) {
		...
		return new MySqlAsyncPreparedQuery(executor, iterator, query, mapper, mode, this.logger, this.cache, queryMetadata, cacheConfig);
	}
...
var MySql2Transaction = class MySql2Transaction extends MySqlAsyncTransaction {
