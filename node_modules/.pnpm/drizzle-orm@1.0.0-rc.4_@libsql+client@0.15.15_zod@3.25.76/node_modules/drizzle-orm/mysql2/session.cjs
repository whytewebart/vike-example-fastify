...
var MySql2Session = class MySql2Session extends __mysql_core_async_session_ts.MySqlAsyncSession {
	...
	prepareQuery(query, mode, mapper, queryMetadata, cacheConfig) {
		...
		return new __mysql_core_async_session_ts.MySqlAsyncPreparedQuery(executor, iterator, query, mapper, mode, this.logger, this.cache, queryMetadata, cacheConfig);
	}
...
var MySql2Transaction = class MySql2Transaction extends __mysql_core_async_session_ts.MySqlAsyncTransaction {
