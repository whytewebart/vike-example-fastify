...
import { MySqlAsyncDatabase, MySqlAsyncDatabase as MySqlDatabase } from "../mysql-core/async/db.cjs";
...
declare class MySql2Database<TRelations extends AnyRelations = EmptyRelations> extends MySqlAsyncDatabase<MySql2QueryResultHKT, TRelations> {
