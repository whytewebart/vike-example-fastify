...
type SQLiteInsertValue<TTable extends SQLiteTable, TModel extends Record<string, any> = InferInsertModel<TTable>> = { [Key in keyof TModel]: TModel[Key] | SQL | Placeholder } & {};
type SQLiteInsertSelection<TTable extends SQLiteTable, TModel extends Record<string, unknown> = InferInsertModel<TTable>> = { [K in keyof TModel]: AnySQLiteColumn | SQL | SQL.Aliased | TModel[K] } & {};
type NoUnknownKeysInInsertSelection<TTable extends SQLiteTable, TSelection extends SQLiteInsertSelection<any>> = { [K in keyof TSelection]: K extends keyof InferInsertModel<TTable> ? TSelection[K] : K extends keyof InferInsertModel<TTable, {
  override: true;
...
declare class SQLiteInsertBuilder<TTable extends SQLiteTable, TRunResult, THKT extends SQLiteInsertHKTBase = SQLiteInsertQueryBuilderHKT> {
  ...
  select<TSelection extends SQLiteInsertSelection<TTable>>(selectQuery: (qb: QueryBuilder) => TypedQueryBuilder<NoUnknownKeysInInsertSelection<TTable, TSelection>>): SQLiteInsertKind<THKT, TTable, TRunResult>;
  ...
  select<TSelection extends SQLiteInsertSelection<TTable>>(selectQuery: TypedQueryBuilder<NoUnknownKeysInInsertSelection<TTable, TSelection>>): SQLiteInsertKind<THKT, TTable, TRunResult>;
}
...
//#endregion
export { AnySQLiteInsert, NoUnknownKeysInInsertSelection, SQLiteInsert, SQLiteInsertBase, SQLiteInsertBuilder, SQLiteInsertBuilderConstructor, SQLiteInsertConfig, SQLiteInsertDynamic, SQLiteInsertHKTBase, SQLiteInsertKind, SQLiteInsertOnConflictDoUpdateConfig, SQLiteInsertQueryBuilderHKT, SQLiteInsertReturning, SQLiteInsertReturningAll, SQLiteInsertSelection, SQLiteInsertValue, SQLiteInsertWithout };
