...
//#region src/effect-d1/session.ts
var EffectSQLiteD1Session = class extends __sqlite_core_effect_session_ts.SQLiteEffectSession {
	static [__entity_ts.entityKind] = "EffectSQLiteD1Session";
	...
	transaction(transaction) {
		...
		return this.client.withTransaction(effect_Effect.gen({ self: this }, function* () {
			return yield* transaction(new EffectSQLiteD1Transaction(dialect, this, relations, void 0, true));
		}));
	}
};
var EffectSQLiteD1Transaction = class extends __sqlite_core_effect_session_ts.SQLiteEffectTransaction {
	static [__entity_ts.entityKind] = "EffectSQLiteD1Transaction";
	transaction(transaction) {
...
//#endregion
exports.EffectSQLiteD1Session = EffectSQLiteD1Session;
exports.EffectSQLiteD1Transaction = EffectSQLiteD1Transaction;
