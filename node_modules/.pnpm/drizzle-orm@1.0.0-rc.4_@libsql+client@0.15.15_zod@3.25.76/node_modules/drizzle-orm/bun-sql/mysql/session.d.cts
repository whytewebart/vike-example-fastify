...
import { MySqlPreparedQueryConfig, MySqlQueryResultHKT, MySqlTransactionConfig } from "../../mysql-core/session.cjs";
import { Logger } from "../../logger.cjs";
import { SQL as SQL$1 } from "bun";
import { Cache } from "../../cache/core/index.cjs";
import { MySqlAsyncPreparedQuery, MySqlAsyncSession, MySqlAsyncTransaction } from "../../mysql-core/async/session.cjs";
...
declare class BunMySqlSession<TSQL extends SQL$1, TRelations extends AnyRelations> extends MySqlAsyncSession<MySqlQueryResultHKT, TRelations> {
...
declare class BunMySqlTransaction<TRelations extends AnyRelations> extends MySqlAsyncTransaction<BunMySqlQueryResultHKT, TRelations> {
  static readonly [entityKind]: string;
