...
const require_bun_sql_mysql_codecs = require('./codecs.cjs');
...
var BunMySqlDatabase = class extends __mysql_core_async_db_ts.MySqlAsyncDatabase {
...
function construct(client, config = {}) {
	...
	const dialect = new __mysql_core_dialect_ts.MySqlDialect({
		...
		codecs: config.codecs ?? require_bun_sql_mysql_codecs.bunSqlMySqlCodecs
	});
	let logger;
