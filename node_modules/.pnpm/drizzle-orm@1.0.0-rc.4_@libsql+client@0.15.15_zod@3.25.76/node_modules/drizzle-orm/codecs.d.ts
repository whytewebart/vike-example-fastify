...
declare class CodecsCollection<TTypeSet extends string = string> {
  ...
  get<TCodecType extends keyof Codec>(column: Column, type: TCodecType, override?: TTypeSet): Codec[typeof arrayToItemTypeCodecNameMap[TCodecType]] | Codec[typeof itemToArrayTypeCodecNameMap[TCodecType]];
  apply<TCodecType extends keyof Codec>(column: Column, type: TCodecType, value: Codec[TCodecType] extends ((v: infer TValue, ...rest: any[]) => any) ? TValue : unknown, override?: TTypeSet): ReturnType<Exclude<Codec[TCodecType], undefined>>;
}
