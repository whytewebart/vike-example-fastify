...
type CockroachInsertSelection<TTable extends CockroachTable<TableConfig>, TModel extends Record<string, unknown> = InferInsertModel<TTable>> = { [K in keyof TModel]: AnyCockroachColumn | SQL | SQL.Aliased | TModel[K] } & {};
type NoUnknownKeysInInsertSelection<TTable extends CockroachTable<TableConfig>, TSelection extends CockroachInsertSelection<any>> = { [K in keyof TSelection]: K extends keyof InferInsertModel<TTable> ? TSelection[K] : K extends keyof InferInsertModel<TTable, {
  override: true;
