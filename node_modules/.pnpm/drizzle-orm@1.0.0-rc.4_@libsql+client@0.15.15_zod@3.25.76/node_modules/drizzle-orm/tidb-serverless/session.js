...
var TiDBServerlessSession = class TiDBServerlessSession extends MySqlAsyncSession {
	...
	prepareQuery(query, mode, mapper, queryMetadata, cacheConfig) {
		...
		return new MySqlAsyncPreparedQuery(executor, void 0, query, mapper, mode, this.logger, this.cache, queryMetadata, cacheConfig);
	}
...
var TiDBServerlessTransaction = class TiDBServerlessTransaction extends MySqlAsyncTransaction {
