...
const require_tidb_serverless_codecs = require('./codecs.cjs');
...
var TiDBServerlessDatabase = class extends __mysql_core_async_db_ts.MySqlAsyncDatabase {
...
function construct(client, config = {}) {
	const dialect = new __mysql_core_dialect_ts.MySqlDialect({
		...
		codecs: config.codecs ?? require_tidb_serverless_codecs.tidbCodecs
	});
	let logger;
