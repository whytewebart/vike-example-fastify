...
import { MySqlAsyncDatabase } from "../mysql-core/async/db.cjs";
import { Config, Connection } from "@tidbcloud/serverless";

//#region src/tidb-serverless/driver.d.ts
declare class TiDBServerlessDatabase<TRelations extends AnyRelations = EmptyRelations> extends MySqlAsyncDatabase<TiDBServerlessQueryResultHKT, TRelations> {
