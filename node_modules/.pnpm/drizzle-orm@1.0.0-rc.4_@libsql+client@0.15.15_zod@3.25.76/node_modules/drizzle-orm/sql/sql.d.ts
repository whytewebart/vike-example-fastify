...
declare class SQL<T = unknown> implements SQLWrapper<T> {
  ...
  mapWith<TDecoder extends DriverValueDecoder<any, Exclude<T, null>> | DriverValueDecoder<any, Exclude<T, null>>['mapFromDriverValue']>(decoder: TDecoder): Equal<T, unknown> extends true ? SQL<GetDecoderResult<TDecoder>> : Equal<T, any> extends true ? SQL<GetDecoderResult<TDecoder>> : SQL<GetDecoderResult<TDecoder> | (null extends T ? null : never)>;
  nullable(): SQL<T | null>;
  inlineParams(): this;
  /**
...
declare class Param<TDataType = any, TDriverParamType = TDataType> implements SQLWrapper {
   ...
   */
  constructor(value: TDataType | Placeholder<string, TDataType>, encoder?: DriverValueEncoder<TDataType, TDriverParamType>, codec?: ((value: any) => any) | undefined);
  getSQL(): SQL<unknown>;
}
...
declare namespace sql {
  ...
  function param<TData, TDriver>(value: TData | Placeholder<string, TData>, encoder?: DriverValueEncoder<TData, TDriver>): Param<TData, TDriver>;
  /**
