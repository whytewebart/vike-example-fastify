...
var SingleStoreSelectQueryBuilderBase = class extends __query_builders_query_builder_ts.TypedQueryBuilder {
	...
	*/
	...
	/** @internal */
	getSQL() {
		this.config.fieldsFlat = (0, __utils_ts.orderSelectedFields)(this.config.fields);
...
var SingleStoreSelectBase = class extends SingleStoreSelectQueryBuilderBase {
	...
	prepare() {
		...
		const preparedQuery = this.session.prepareQuery(query, fieldsList, void 0, void 0, void 0, {
			type: "select",
