export default {
    ...
    value: ({ props }) => ({
        class: [
            ...
            {
                'before:absolute before-content-empty before:top-0 before:left-0 before:bottom-0 before:bg-inherit ': props.mode == 'indeterminate',
                'after:absolute after:top-0 after:left-0 after:bottom-0 after:bg-inherit before-content-empty after:delay-1000': props.mode == 'indeterminate'
            }
        ]
    }),
    label: {
