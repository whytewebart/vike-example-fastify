export default {
    root: ({ props, context }) => ({
        class: [
            ...
            {
                'text-surface-600 dark:text-white/60 before:bg-transparent before:content-empty': !context.active,
                'text-surface-800 dark:text-white/80 before:bg-surface-0 dark:before:bg-surface-800 before:content-empty': context.active
            },
